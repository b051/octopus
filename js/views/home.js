...
(function() {
  App.HomeView = Parse.View.extend({
    ...
    initialize: function() {},
    render: function() {
      var plot, previousPoint, showInstrumenttip, visitors, visits;
      this.$el.html(this.template({}));
      showInstrumenttip = function(x, y, contents) {
      ...
      $("#statsChart").bind("plothover", function(event, pos, item) {
        ...
        if (item) {
          if (previousPoint !== item.dataIndex) {
            ...
            return showInstrumenttip(item.pageX, item.pageY, item.series.label + " of " + month + ": " + y);
          }
        } else {
          $("#tooltip").remove();
